...
%% Data Cleaning
% Load sensor data
sensor = load('../data_aq/data_logs/com_data_20250219_201647.mat');
gt = readmatrix('../data_gt/201647.xlsx');
...
save('cleaned_data_201647.mat', 'time', 'rb0_interp', 'rb1_interp', 'rb2_interp', ...
...
hold on
title('interp1 check');
plot(time, (sensor_data(:,20)-mean(sensor_data(:,20))))
plot(time, ((rb1_interp(:,1)-mean(rb1_interp(:,1)))*2))
legend('sensor', 'gt')